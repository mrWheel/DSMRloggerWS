...
-- Het script werkt met firmware V3 & V4 en is getest met hardware V3. 
...
-- Script parameters
-----------------------------------------------------------------------------------------------
local DSMR_IP = "DSMR-WS.local"   -- Ip-Adres ESP-DSMR Slimme Meter Logger of 
                                  -- gebruik: V3: ESP01-DSMR.local of V4: DSMR-WS.local
Firmware      = "V4"              -- Vul in welke firmware je gebruikt. V3 of V4
Debug         = "Ja"              -- Zet Debug op Ja om in Domoticz Log alle JSON 
                                  -- waardes te registreren. 
                                  -- Keuze  "Ja" of "Nee" (hoofdlettergevoelig)
...
-- Je kunt zelf bepalen welke dummy switchen je wilt bijwerken in Domoticz door de -- ervoor te 
-- verwijderen, de betreffende dummy switchen aan te maken in Domoticz (achter elk item staat 
-- beschreven welke optie je moet kiezen bij het aanmaken van de dummy) en het IDX nummer in te 
-- vullen.
-----------------------------------------------------------------------------------------------
...
-- Je kunt zelf bepalen welke dummy switchen je wilt bijwerken in Domoticz door de -- ervoor te 
-- verwijderen, de betreffende dummy switchen aan te maken in Domoticz (achter elk item staat 
-- beschreven welke optie je moet kiezen bij het aanmaken van de dummy) en het IDX nummer in 
-- te vullen.
-----------------------------------------------------------------------------------------------
...
-----------------------------------------------------------------------------------------------
-- Instellingen voor Firmware V3 - Deze instellingen niet aanpassen !!
-----------------------------------------------------------------------------------------------
...
-----------------------------------------------------------------------------------------------
-- Instellingen voor Firmware V4 - Deze instellingen niet aanpassen !!
-----------------------------------------------------------------------------------------------

elseif Firmware=="V4" then
    json = (loadfile "/home/pi/domoticz/scripts/lua/JSON.lua")()
...
-----------------------------------------------------------------------------------------------
-- Log instellingen voor terugleveren van stroom. Deze kun je aanzetten als je ook stroom 
-- teruglevert.
-- Je kunt zelf bepalen welke dummy switchen je wilt bijwerken in Domoticz door de -- ervoor 
-- te verwijderen.
-----------------------------------------------------------------------------------------------
...
-- Welke dummy switchen moeten worden bijgewerkt in Domoticz voor leveren stroom & Gas (Alleen 
-- voor stroomafname)
-- Je kunt zelf bepalen welke dummy switchen je wilt bijwerken in Domoticz door de -- ervoor 
-- te verwijderen.
-----------------------------------------------------------------------------------------------
...
-----------------------------------------------------------------------------------------------
-- Welke dummy switchen moeten worden bijgewerkt in Domoticz voor terugleveren stroom. (Als je ook stroom teruglevert)
